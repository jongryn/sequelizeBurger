/*
// Created: Oct. 3, 2017 11:50 AM
// Author: Jonathan Gryn
// Revisions: Jon (10/3/17) - Started server.js
*/
...
var db = require(path.join(__dirnmae, '/models'));

// Serve static content for the app from the 'public' directory
app.use(express.static(process.cwd() + '/public'));

// Override with POST have ?_method=PUT
...
db.sequelize.sync().then(function() {
    app.listen(port, function() {
        console.log("sequelizeBurger is listening on PORT " + port);
    });
});